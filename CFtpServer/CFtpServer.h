...
#ifdef FTPSERVER_EXPORTS
#define FTPSERVER_API __declspec(dllexport)
#else
#define FTPSERVER_API __declspec(dllimport)
#endif
 ...
 */
class FTPSERVER_API CFtpServer
{
	public:
		////////////////////////////////////////
	...
	private:
      ...
      class FTPSERVER_API CCriticialSection
		{
			public:
        bool Initialize()
        {
    ...
    class CCriticialSection FtpServerLock;
 ...
 */
class FTPSERVER_API CFtpServer::CUserEntry
{
	public:
 ...
 */
class FTPSERVER_API CFtpServer::CClientEntry
{
	public:
 ...
 */
class FTPSERVER_API CFtpServer::CEnumFileInfo
{
	public:
